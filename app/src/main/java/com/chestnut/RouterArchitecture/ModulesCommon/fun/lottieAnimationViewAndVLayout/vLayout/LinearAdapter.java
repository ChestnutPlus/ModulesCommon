package com.chestnut.RouterArchitecture.ModulesCommon.fun.lottieAnimationViewAndVLayout.vLayout;
...
public class LinearAdapter extends DelegateAdapter.Adapter<LinearAdapter.LinearViewHolder>{
    ...
    public LinearViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new LinearViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_v_layout,parent,false));
    }
