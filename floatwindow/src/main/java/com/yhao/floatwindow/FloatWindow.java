...
public class FloatWindow {
    ...
    public static class B {
        ...
        B(Context applicationContext) {
            SPUtils.getInstance().init(applicationContext,mDefaultTag);
        ...
        public void build() {
            ...
            if (isRecordXY) {
                setX(SPUtils.getInstance().getInt("END_X",xOffset));
                setY(SPUtils.getInstance().getInt("END_Y",yOffset));
            }
            IFloatWindow floatWindowImpl = new IFloatWindowImpl(this,isRecordXY);
